...
import profilePic from "../assets/avatar-snap-simon.jpg";
  ...
  return (
    <section className='max-w-screen-xl flex flex-col gap-14 md:flex-row md:items-center pt-16 md:pt-28 pb-20 px-6 mx-auto' id='hero'>
      ...
      <div className='flex-1 text-center md:text-left z-[1]'>
        <span className='text-xs md:text-sm text-blue-200 font-thin'>A Web Developer</span>
      ...
      <div className='flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]'>
        <div className='w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-950 p-6'>
          <div className='flex items-center justify-center'>
            <img className='hero-img' src={profilePic} alt="img one" />
          </div>
          ...
          <InfoTile
            ...
            <div className='flex items-center gap-2 flex-wrap'>
              ...
              <div className='bg-blue-800/30 p-2 rounded'>
                <a href="https://github.com/sgc-11" target='_blank'>
                <FaGithub className='text-lg md:text-xl' />
                </a>
              </div>

              <div className='bg-blue-800/30 p-2 rounded'>
              <a href="https://www.linkedin.com/in/simon-gomez-9149b4243/" target='_blank'>
...
const InfoTile: React.FC<InfoTileProps> = ({ icon, text }) => {
  return (
    <div className='flex items-center gap-4 bg-cardbg p-4 mt-3 rounded-mb'>
      {icon}
